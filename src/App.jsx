...
function App() {
  ...
  return (
    <div className="min-h-screen p-4 mb-10 bg-gray-100">
      <section className="my-5 flex flex-row justify-between max-w-7xl mx-auto">
        <div className="flex items-center">
          <input
            className="input input-primary input-sm input-bordered rounded-sm min-w-[300px]"
            placeholder="Search..."
            value={searchQuery}
            onChange={(e) => {
          ...
          />
          <button
            className="btn btn-link rounded-sm border btn-sm search-icon ml-2 hover:bg-blue-500"
            onClick={() => {
              searchData();
              setPage(1);
            }}
      ...
      <section className="border rounded-lg max-w-7xl mx-auto py-2">
        <table className="table table-xs table-pin-rows bg-gray-200">
          <thead>
            <tr className="table-row text-primary">
              ...
              <th className="text-blue-500 text-sm">Name</th>
              <th className="text-blue-500 text-sm">Email</th>
              <th className="text-blue-500 text-sm">Role</th>
              <th className="text-blue-500 text-sm">Actions</th>
            </tr>
          </thead>
              ...
              <tr
                ...
                className={`table-row bg-base-100 ${
                  editing.mode && item.id === editing.id
                    ...
                    : ""
                } ${selected.includes(item.id) ? "bg-gray-300" : ""}`}
              >
                <td>
                  <input
                    className="checkbox-primary checkbox rounded-sm checkbox-xs"
                ...
                <td>
                  <input
                    ...
                    className="form-control input input-primary disabled:bg-red-300 disabled:border-none disabled:text-neutral disabled:cursor-default"
                  />
                </td>
                <td>
                  <div
